  ...
  return (
    <div class="content">
      ...
      <p>
        ...
        Minima commodi libero alias vitae suscipit, excepturi repudiandae unde,
        inventore at veritatis hic quam nobis architecto reprehenderit nam quo
        natus atque quidem. Itaque architecto amet aliquid, iure, obcaecati
        laudantium nisi nulla praesentium velit pariatur iusto earum totam
        minima libero, dolorem facere quibusdam maxime commodi et rerum aperiam
        inventore quos. Reprehenderit molestias laboriosam voluptatem quod
        adipisci obcaecati. Incidunt explicabo earum tenetur sapiente,
        necessitatibus unde architecto porro nostrum velit? Officiis repellat
        nesciunt reprehenderit. Ducimus at molestiae ratione ab, quod accusamus
        amet dolor blanditiis eligendi impedit!
      </p>
      <br />
      <p>
        ...
        placeat expedita incidunt accusantium exercitationem vel accusamus modi
        ab voluptas at itaque et, asperiores earum illo id iusto temporibus
        cumque maxime quas eius!
      </p>
    </div>
  );
};
